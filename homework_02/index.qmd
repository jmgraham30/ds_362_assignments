...
Use the `qr` command in R to compute the $QR$ factorization of each of the following matrices. Write down the sizes of the $Q$ and $R$ matrices in each case and state the rank of $A$.
