...
In the previous code, three are three regression models `basic_rec` (includes all predictors), `rotor_hub_rec` (removes the commissioning data predictor), and `commissioning_rec` (removes the rotor and hub measurement variables).  
